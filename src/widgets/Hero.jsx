...
function Hero() {
    return (
        <div className='grid justify-items-center gap-8 pb-28 relative'>
            ...
            <p className='text-xl text-gray-700 md:w-1/2 text-center'>这是一个测试这是一个测试这是一个测试这是一个测试这是一个测试这是一个测试这是一个测试这是一个测试</p>
            <div>
            ...
            <div className='relative grid justify-items-center'>
                ...
                <div className='flex absoulute rounded-full bg-white -bottom-7 px-5 py-4 drop-shadow-xl'>
                    <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
