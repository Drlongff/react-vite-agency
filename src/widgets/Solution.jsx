...
function Solution() {
    return (
        <div>
            <SectionHeading title="解决方案" subTitle="找我们就对了找我们就对了找我们就对了找我们就对了找我们就对了找我们就对了" />
                    ...
                    <ul className='grid gap-3'>
                        {
                            [1, 2, 3].map((v) => (
                                <li className={`p-5 justify-between rounded border border-zinc-100 ${v === 1 && "bg-zinc-100"}`} key={v}>
                                    <p className='text-lg font-bold'>构件简单的生态系统</p>
                                    <div className='flex justify-between relative'>
                                        <p className='text-lg leading-7 mt-1'>可以构件简单的生态系统构件简单的生态系统构件简单的生态系统</p>
                                        <svg
                                            width="38"
                                            height="38"
                                            viewBox="0 0 38 38"
